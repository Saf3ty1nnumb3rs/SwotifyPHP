...
<html>
<head>
	<title>Welcome to Swotify!</title>
	...
	<div id="background">
		<div id="loginContainer">
			<div id="inputContainer">
				<form id="loginForm" action="register.php" method="POST">
					...
					<p>	
						...
						<input id="loginUsername" name="loginUsername" type="text" placeholder="Username Login" value="<?php getInputValue('loginUsername') ?>" required>
					</p>
					<p>
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="username" name="username" type="text" placeholder="Enter username" value="<?php getInputValue('username') ?>" required>
					</p>
					...
					<p>
						...
						<input id="email" name="email" type="email" placeholder="your@email.com" value="<?php getInputValue('email') ?>" required>
					</p>
					...
					<p>
						<p><?php echo $account->getError(Constants::$passwordsDoNoMatch); ?></p>
						<p><?php echo $account->getError(Constants::$passwordNotAlphanumeric); ?></p>
						<p><?php echo $account->getError(Constants::$passwordCharacters); ?></p>
			...
			<div id="loginText">
				...
				<h2>Listen to piles of music for free.</h2>
				<ul>
